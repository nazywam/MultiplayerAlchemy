...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Michael", "MultiplayerAlchemy", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "MultiplayerAlchemy";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "MultiplayerAlchemy", null, { width: 512, height: 512 });
